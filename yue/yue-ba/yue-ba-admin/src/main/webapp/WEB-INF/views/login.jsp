...
<head>
    ...
    <link rel="search" type="application/opensearchdescription+xml" href="https://catfan.me/opensearch.php"
          title="Add Catfan search"/>

    <link rel="icon" type="image/png" sizes="32x32" href="https://catfan.me/favicon-32x32.png"/>
    <link rel="icon" type="image/png" sizes="16x16" href="https://catfan.me/favicon-16x16.png"/>

    <%-- 单选框scc --%>
    <link rel="stylesheet" type="text/css" href="/static/assets/css/bootstrap-switch.min.css" />
    <link rel="stylesheet" type="text/css" href="/static/assets/css/components-rounded.min.css" />
    ...
    <div id="content-head">
        ...
        <div id="login_wrap">
            <div id="login_box">
                ...
                <div id="login_status">用户名或密码不正确</div>
        ...
        <div id="signup_wrap">
            <div id="signup_box">
                ...
                <input type="text" class="signup_input" id="signup_user_name" onkeyup="signup.check('user_name')"
                       onfocus="signup.focus('user_name')" onblur="signup.blur('user_name')"/>

                <div id="signup_url_container">https://yueba.me/
                    <span id="signup_url_label"></span></div>
                <div class="label-wrap">
                    <label>密码</label>
                    <span class="signup_tips" id="password_tips">6 个字符以上</span></div>
                <input type="password" class="signup_input" id="signup_password" onkeyup="signup.check('password')"
                       onfocus="signup.focus('password')" onblur="signup.blur('password')"/>

                <div class="label-wrap">
                    <label>电子邮箱</label>
                    <span class="signup_tips" id="email_tips">用来联系的电子邮箱，不会公开</span></div>
                <input type="text" class="signup_input" id="signup_email" onkeyup="signup.check('email')"
                       onfocus="signup.focus('email')" onblur="signup.blur('email')"/>
                ...
                <div class="label-wrap form-group form-md-radios">
                    <label>性别</label>
                    <span class="signup_tips" id="nick_name_tips">一个能让别人识别到您的名字</span></div>
                <input id="gender" type="hidden" value="1">
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="radio1" name="gender" value="1" class="md-radiobtn" checked="" onclick="radioResult(this.value)">
                        <label for="radio1">
                            <span class="inc"></span>
                            <span class="check"></span>
                            <span class="box"></span> 兄 贵 </label>
                    </div>
                    <div class="md-radio has-error" id="md-radio">
                        <input type="radio" id="radio2" name="gender" value="0" class="md-radiobtn" onclick="radioResult(this.value)">
                        <label for="radio2">
                            <span class="inc"></span>
                            <span class="check"></span>
                            <span class="box"></span> 萌 妹 </label>
                    </div>

                </div>

                <div id="signup_tos">如您注册，您必须同意 约吧 的
...
<div id="content-container">
    <div id="content-item-body">
        ...
        <%--style="background-image: url('https://catf.me/photos/ab69fa5dfe208c887f47124ed56b634f.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/Numpkin/p361339">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/a0f1436bae566aed3defdaada8e37e3a.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/Numpkin/p361215">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/4abf8a450c87845a9e80cda8f13eb3b4.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/sosososo/p361223">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/0e5c56addd48da06db81744e2406f63e.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/catl/p361377">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/e6721ef9e3b88710a585242c358d12ac.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/catl/p361337">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/9916d184147d8b0984a4443d1c13405d.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/AGAM/p361375">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/152408c5f9912ecac1938bd4c2e3253d.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/sosososo/p361205">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/395d2afacef2d4f6da1001a0d4643ebe.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/tomdotk/p361350">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/4d3cf026fdce92f81f8a5588bf5803b0.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/manekineko/p361265">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/4e756aca95e6b32ea2a3ae25e5779b16.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/w2jmoe/p361330">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://i.loli.net/2018/12/14/5c13bad5dd55b.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--<li>--%>
        <%--<a href="https://catfan.in/sosososo/p361261">--%>
        <%--<div class="content-item"--%>
        <%--style="background-image: url('https://catf.me/photos/916594900cef05f7f3453a9c1ce88b9c.jpg')"></div>--%>
        <%--</a>--%>
        <%--</li>--%>
        <%--</ul>--%>
    </div>
